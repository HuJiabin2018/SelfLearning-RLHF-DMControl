...
from reward_model_semi_dataaug import RewardModelSemiDataAug
...
class Workspace(object):
    ...
    def run(self):
        ...
        while self.step < self.cfg.num_train_steps:
            ...
            self.reward_model.add_data(obs, action, reward[0], done)
...
@hydra.main(config_path='config/train_PEBBLE_semi_dataaug.yaml', strict=True)
def main(cfg):
